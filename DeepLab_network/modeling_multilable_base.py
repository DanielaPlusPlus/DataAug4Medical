from .utils_multilable_base import IntermediateLayerGetter
from ._deeplab_multilable_base import DeepLabHeadV3Plus, DeepLabV3
...
def _segm_resnet(name, backbone_name, output_stride, num_classes, pretrained_backbone):
    ...
    #     classifier = DeepLabHead(inplanes , aspp_dilate)
...
def _segm_mobilenet(name, backbone_name, num_classes, output_stride, pretrained_backbone):
    ...
    if name=='deeplabv3plus':
        ...
        classifier = DeepLabHeadV3Plus(inplanes, low_level_planes, aspp_dilate)
    # elif name=='deeplabv3':
...
#补充
def _segm_tinyvit(name, backbone_name, num_classes, pretrained_backbone):
    backbone = TinyViT.__dict__[backbone_name](
        pretrained=pretrained_backbone)
...
def _load_model(arch_type, backbone, output_stride, num_classes, pretrained_backbone):

    if backbone=='mobilenetv2':
        model = _segm_mobilenet(arch_type, backbone, output_stride=output_stride, pretrained_backbone=pretrained_backbone)
    elif backbone.startswith('resnet'):
        model = _segm_resnet(arch_type, backbone, output_stride=output_stride, num_classes=num_classes, pretrained_backbone=pretrained_backbone)
    elif backbone.startswith('hrnetv2'):
        model = _segm_hrnet(arch_type, backbone,  pretrained_backbone=pretrained_backbone)
    elif backbone=='xception':
        model = _segm_xception(arch_type, backbone, output_stride=output_stride, pretrained_backbone=pretrained_backbone)
    #补充
    elif backbone=='tinyvit':
        model = _segm_tinyvit(arch_type, backbone, output_stride=output_stride, pretrained_backbone=pretrained_backbone)
    else:
...
def deeplabv3_resnet50(num_classes=21, output_stride=8, pretrained_backbone=True):
    ...
    """
    return _load_model('deeplabv3', 'resnet50', num_classes=num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone)
...
def deeplabv3_resnet101(num_classes=21, output_stride=8, pretrained_backbone=True):
    ...
    Args:
        ...
        pretrained_backbone (bool): If True, use the pretrained backbone.
    """
    return _load_model('deeplabv3', 'resnet101', num_classes=num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone)
...
def deeplabv3plus_resnet101(num_classes=9, output_stride=8, pretrained_backbone=True):
    """Constructs a DeepLabV3+ model with a ResNet-101 backbone.
    ...
    Args:
        ...
        pretrained_backbone (bool): If True, use the pretrained backbone.
    """
    return _load_model('deeplabv3plus', 'resnet101', num_classes=num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone)
...
#补充
def deeplabv3plus_TinyViT_11m_224(pretrained=True, num_classes=21,output_stride=8):
    """Constructs a DeepLabV3+ model with a TinyViT_11m_224 backbone.

    Args:
        pretrained (bool): If True, use the pretrained backbone.
        num_classes (int): number of classes.
        output_stride (int): output stride for deeplab.
    """
    return _load_model('deeplabv3plus', 'TinyViT_11m_224', num_classes, output_stride=output_stride, pretrained_backbone=pretrained)