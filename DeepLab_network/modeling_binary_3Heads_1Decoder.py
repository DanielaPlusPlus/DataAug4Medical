from .utils_binary_3Heads_1Decoder import IntermediateLayerGetter
from ._deeplab_binary_3Heads_1Decoder import DeepLabHeadV3Plus, DeepLabV3
...
def _segm_resnet(name, backbone_name, output_stride, pretrained_backbone):
...
def _load_model(arch_type, backbone, output_stride, pretrained_backbone):
    ...
    if backbone=='mobilenetv2':
        ...
        model = _segm_resnet(arch_type, backbone, output_stride=output_stride, pretrained_backbone=pretrained_backbone)
...
def deeplabv3plus_resnet101(output_stride=8, pretrained_backbone=True):
    ...
    Args:
        ...
        pretrained_backbone (bool): If True, use the pretrained backbone.
    """
    return _load_model('deeplabv3plus', 'resnet101', output_stride=output_stride, pretrained_backbone=pretrained_backbone)
